...
describe('Dashboards', () => {
  ...
  it('renders', () => {
    ...
    const expected = getAllByTestId('dashboard-index--cell')
  ...
  it('filters on label click', () => {
    ...
    expect(getAllByTestId('dashboard-index--cell')).toHaveLength(2)

    fireEvent.click(labelPill)

    expect(getAllByTestId('dashboard-index--row 2')).toHaveLength(1)
    expect(getAllByTestId('dashboard-index--cell')).toHaveLength(1)
  })
